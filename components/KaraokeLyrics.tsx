...
export function KaraokeLyrics({
  ...
  const handleTimeUpdate = useCallback(() => {
    ...
    if (startTime && endTime && currentSeconds >= endTime) {
        ...
        <div className="flex flex-col justify-center w-screen items-center fixed bottom-0">
          ...
          <div className="flex justify-center w-2/3">
            ...
            <div className="flex flex-col items-center justify-center">
              <audio
                className={
                  s ? "h-4 w-3xs" : "opacity-0 w-[1px] h-[1px] absolute"
                }
                ref={audioRef}
                src={audioSrc}
              ...
              {!s && (
                <div className="flex">
                  <button
                    className="text-center rainbow text-[6rem] lg:text-[8rem] touch-manipulation select-none"
